...
# Everything in Python is an object, there is an object class actually, and every object can have attributes and methods.
# There is a dir() function which returns a list of all the attributes and methods of the specified object.
# For example:
a="Hello"
print(dir(a))
